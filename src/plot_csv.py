...
df = pd.read_csv('savedata/lcell_1pi-20pi_npart20000_ncell40.csv')
...
ax[0].set_title('Parameters vs Cell Length (ncells=40, npart=20000)')
ax[-1].set_xlabel('Cell Length ($\pi$)')
